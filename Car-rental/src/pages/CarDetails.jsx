...
const CarDetails = () => {
  ...
  return car ? (
    ...
    <motion.form
     ...
     onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-600 '>
        ...
        <hr className='border-borderColor my-6'/>
                <div className='flex flex-col gap-2'>
                    ...
                    <input value={pickupDate} onChange={e=>setPickupDate(e.target.value)} type="date" id="pickup-date" className='border borderColor px-3 py-2 rounded-lg ' required min={new Date().toISOString().split("T")[0]} />
                </div>
                <div className='flex flex-col gap-2'>
                ...
                <button className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white rounded-xl'>Book Now</button>
