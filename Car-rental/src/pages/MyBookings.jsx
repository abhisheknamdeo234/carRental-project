                ...
                transition={{delay:idx*0.1,duration:0.4}}
                 key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6  border border-borderColor rounded-lg mt-5 first:mt-12'>
                    ...
                    <div className='md:col-span-1'>
                        ...
                        <p className='text-lgfont-medium mt-2'>{booking.car.brand} {booking.car.model}</p>
                    ...
                    <div className='md:col-span-2'>
                        <div className='flex items-center gap-2 '>
                            ...
                            <p className={`px-3 py-1 text-xs rounded-full ${booking.status==='confirmed' ?`bg-green-400/15 text-green-400`:`bg-red-400/15 text-red-600`}`}>{booking.status}</p>
                        </div>
